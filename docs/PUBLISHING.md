...
```text
Codex Pet Director v0.3.0
```

Short release description:

```text
Adds the /create-pet start entry, beginner quick-start docs, example brief, and release-ready install paths.
```
